...
import { getCaptureEvents, getCaptureTokens } from '@/lib/queries';
import { GestioneToken, RegistroCatture } from './gestione-token';

export const dynamic = 'force-dynamic';

export default async function ImpostazioniPage() {
  const [tokens, eventi] = await Promise.all([getCaptureTokens(), getCaptureEvents()]);

  return (
    <div className="mx-auto flex max-w-3xl flex-col gap-8">
      <TitoloSchermata sopra="Impostazioni">Cattura</TitoloSchermata>
